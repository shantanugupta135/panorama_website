<template>
  <div class="bg-white">
      ...
      >
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img
              class="h-8 w-auto"
              src="https://panoramacorp.in/img/logo_new.png"
              alt=""
            />
          </a>
        </div>
    ...
    <main>
      <!-- Hero section -->
      <div
        class="relative isolate overflow-hidden bg-gray-900 pt-14 pb-16 sm:pb-20"
      >
        <img
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-3xl py-32 sm:py-32 lg:py-48">
            <div class="text-center">
              ...
              >
                Invest in <span class="text-indigo-500">Verification</span>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-5xl sm:text-center">
            ...
            >
              ...
              <span class="text-red-700">C</span>ustomer?
            </p>
      ...
      <!-- Blog section -->
      <div class="bg-white py-2 sm:py-8">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div
            class="mx-auto mt-6 grid max-w-2xl grid-cols-1 gap-y-20 gap-x-8 lg:mx-0 lg:max-w-none lg:grid-cols-3"
          >
            <article
              v-for="post in posts"
              :key="post.id"
      ...
      <div class="relative isolate bg-white">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
          <div
            class="relative px-6 pt-4 pb-10 sm:pt-12 lg:static lg:py-24 lg:px-8"
          >
          ...
          <div class="px-6 pb-10 pt-4 sm:pb-10 lg:py-24 lg:px-8">
            <div class="gmap2">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.7130083749626!2d77.29069781548098!3d28.60838528242727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce4a21abbe573%3A0x56847a2f5a456962!2sPANORAMA%20CORPORATION!5e0!3m2!1sen!2sin!4v1617796455859!5m2!1sen!2sin"
                width="600"
                height="450"
                style="border: 0"
                allowfullscreen=""
